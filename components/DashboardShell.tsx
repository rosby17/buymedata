...
type Profile = { name: string; email: string; username?: string | null; avatar_url?: string | null };

export default function DashboardShell({ children, profile }: { children: React.ReactNode; profile: Profile }) {
  ...
  return <><Navbar dashboardLayout initialUser={profile} /><div className="min-h-screen bg-[#f5f3ee]">
