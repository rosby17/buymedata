      ...
      >
        <div className="max-w-md w-full mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-3 mb-6 bg-gray-50 p-2 rounded-xl border" style={{ borderColor: "#e4bdbc" }}>
            ...
            <button type="button" onClick={() => { window.location.href = `/api/auth/google?intent=signup&username=${encodeURIComponent(username)}`; }} className="w-full flex justify-center items-center gap-2 py-3 px-4 border rounded-xl bg-white text-sm font-bold text-[#1b1c19] hover:bg-gray-50 transition-colors" style={{ borderColor: "#e4bdbc" }}>
