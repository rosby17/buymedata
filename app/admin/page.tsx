...
export default function AdminDashboard() {
  ...
  return <div className="min-h-screen bg-[#fbf9f4] text-[#1b1c19]"><nav className="border-b border-[#e4bdbc] bg-white"><div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-5"><Link href="/" className="flex items-center gap-2"><TopUpLogo className="h-8 w-8"/><span className="font-bold text-[#b20024]">Buy Me Data · Admin</span></Link><Link href="/dashboard" className="text-sm font-semibold text-[#5b403f]">Mon espace</Link></div></nav>
