...
export async function GET() {
  ...
  const result = await query("SELECT id, email, full_name, role, phone, avatar_url, username, bio, category, onboarding_completed, created_at FROM profiles WHERE id = $1", [id]);
