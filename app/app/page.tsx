...
export default function DashboardPage() {
  ...
  useEffect(()=>{const timer=window.setTimeout(()=>{load().catch(()=>{setLoadError("Les chiffres n’ont pas pu être actualisés.");setLoading(false);});},0);return()=>window.clearTimeout(timer);},[]);
